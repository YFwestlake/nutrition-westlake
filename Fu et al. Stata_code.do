...
clear
use "/Users/Yuanqing/Work/承担项目/Project_n_of_1_data_analyses/data_analysis_0323/混合线性模型分析菌群影响MAGE/各set内菌种平均值数据/各set内平均speciess3.dta"
...
merge 1:1 id using "/Users/Yuanqing/Work/承担项目/Project_n_of_1_data_analyses/data_analysis_0323/混合线性模型分析菌群影响MAGE/各set内菌种平均值数据/各set内平均species`var'.dta"
drop _merge
}

merge 1:1 id using  "/Users/Yuanqing/Work/承担项目/Project_n_of_1_data_analyses/data_analysis_0323/混合线性模型分析菌群影响MAGE/每日PMG数据.dta" 
drop if _merge!=3
drop _merge
gen ID=substr(id, 1, 6)
order ID
merge 1:1 id using "/Users/Yuanqing/Work/承担项目/Project_n_of_1_data_analyses/data_analysis_0323/混合线性模型分析菌群影响MAGE/baseline信息.dta"
drop if _merge==2
...
preserve
drop if fat=="1" //fat=0为低脂  fat=1为高脂
...
restore
drop if fat=="0" //fat=0为低脂  fat=1为高脂
replace mean_HPT=mean_HPT*100
mixed mean_MAGE dim1 dim2 dim3 age i.sex bmi activity || ID:, reml dfmethod(repeated)  
mixed mean_MPG dim1 dim2 dim3 age i.sex bmi activity || ID:, reml dfmethod(repeated)  
mixed mean_HPT dim1 dim2 dim3 age i.sex bmi activity || ID:, reml dfmethod(repeated) 
...
merge 1:1 ID using "/Users/Yuanqing/Work/承担项目/Project_n_of_1_data_analyses/data_analysis_0323/混合线性模型分析菌群影响MAGE/广东队列宏基因组验证/KO_pathway_matchtable_2023_4439.dta" 
order ID user_id seq
sort user_id seq
drop _merge 
